function [fast,delay]=plot_curves_2l_dip(final_model,top,freq,baz,mod_plot,phi,phipos,phineg,dt,dtpos,dtneg)
...
if max(phi_hor(:))>90
    ...
    for i=1:size(delay,1)
        if i==1
            c1=plot(baz_plot,delay(i,:),'Color',[255/255, 85/255, 85/255],'LineWidth',2);
        else
    ...
    legend(c1,'Lowest Misfit Model','HandleVisibility', 'off');
